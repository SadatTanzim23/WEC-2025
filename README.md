...
Please understand my solution and give me good ideas for how I can implement everything. Tell me what you need from me to create this project and how I can deploy it on my local machine. I am open to use whatever to make this, it doesnt need to be deployed online, only needs to be shown on my laptop. I want to say that everything should have graphics and look nice, so whatever images you need from me, let me know.
